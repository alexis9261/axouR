                ...
                <div class="row justify-content-center my-3">
                  <div class="input-group col-6">
                    <div class="input-group-append">
                      <span class="input-group-text"><b>Nombre de la Talla</b></span>
                    </div>
                    <input type="text" id="nombre_talla" class="form-control text-secondary" placeholder="Ingrese el nombre de la talla" maxlength="10" required>
                  </div>
                  <div class="col-2">
          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="card">
                ...
                <?php
                $sql="SELECT * FROM TALLAS WHERE ESTATUS=$estatus LIMIT $start,$perpage";
                    ...
                    <tbody>
                      ...
                      while($row=$result->fetch_assoc()){
                        ...
                        <tr class="text-center">
                          ...
                          <td class="p-0 p-2">
                            <?php if (isset($_GET['estatus']) && $_GET['estatus']==1){ ?>
                              <a class="btn btn-link" href="?id=<?php echo $idtalla;?>&band=1">
                            ...
                            <?php }else{ ?>
                              <a class="btn btn-link" href="?id=<?php echo $idtalla;?>&band=0">
                        ...
                        <script>
                          $(document).ready(function(){
                            ...
                            if(activar==1){
                              const toast=swal.mixin({toast:true,position:'top-end',showConfirmButton:false,timer:3500});
                              toast({type:'success',title:'¡La talla fue activada exitosamente!'})
                            }else if(activar==2){
                              const toast=swal.mixin({toast:true,position:'top-end',showConfirmButton:false,timer:3500});
                              toast({type:'error',title:'¡Hubo un pequeño problema! \n Inténtalo de nuevo'})
                            }
                        ...
                        <script>
                          $(document).ready(function(){
                            ...
                            if(pausar==1){
                              const toast=swal.mixin({toast:true,position:'top-end',showConfirmButton:false,timer:3500});
                              toast({type:'success',title:'¡La talla fue pausada exitosamente!'})
                            }else if(pausar==2){
                              const toast=swal.mixin({toast:true,position:'top-end',showConfirmButton:false,timer:3500});
                              toast({type:'error',title:'¡Hubo un pequeño problema! \n Inténtalo de nuevo'})
                            }
