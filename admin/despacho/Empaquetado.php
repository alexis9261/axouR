                ...
                if($result2->num_rows>0){
                  while($row2=$result2->fetch_assoc()){
                    ...
                    <tr>
                      ...
                      <td><?=$fecha?></td>
                      <td>
                        <span class="font-medium"><button type="button" class="enlace2 ml-auto" href="javascript:void(0)" data-toggle="modal" data-target="#ver<?php echo $id;?>">Ver artículos</button></span>
                      </td>
                      <td class="text-center">
                        <a id="good" class="btn btn-outline-success btn-sm px-3" href="empaquetado.php?orden=good&id=<?php echo $id;?>">Listo</a>
